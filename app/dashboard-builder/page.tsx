    ...
    <div className="flex items-center justify-center p-6 min-h-screen">
      <div className="max-w-3xl w-full">
        ...
        <Card className="p-10 text-center">
          <h1 className="text-3xl font-bold mb-6">Конструктор дэшбордов</h1>
          <div className="mb-8">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Конструктор дэшбордов позволит создавать собственные информационные панели из доступных 
              датчиков и метрик системы мониторинга, настраивать визуализацию и обновление данных в реальном времени.
            </p>
          </div>
